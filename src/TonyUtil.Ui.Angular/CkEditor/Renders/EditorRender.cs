...
using TonyUtil.Ui.CkEditor.Builders;
using TonyUtil.Ui.CkEditor.Configs;
using TonyUtil.Ui.CkEditor.Resolvers;
using TonyUtil.Ui.Configs;

namespace TonyUtil.Ui.CkEditor.Renders {
    /// <summary>
    /// 富文本框编辑器渲染器
    /// </summary>
    public class EditorRender : AngularRenderBase {
        ...
        private void ConfigCkEditor( TagBuilder builder ) {
            ...
            var json = Helpers.Json.ToJson( config, true );
            if ( json == "{}" )
                return;
