...
using TonyUtil.Ui.Attributes;
using TonyUtil.Ui.Configs;
using TonyUtil.Ui.Material.Forms.Configs;

namespace TonyUtil.Ui.Material.Internal {
    /// <summary>
    /// 辅助操作
    /// </summary>
    internal static class Helper {
        ...
        private static void Init( IConfig config, Type modelType, MemberInfo member, string propertyName ) {
            config.SetAttribute( UiConst.Name, Helpers.String.FirstLowerCase( propertyName ) );
        ...
        private static string GetModel( string modelName, string propertyName ) {
            modelName = Helpers.String.FirstLowerCase( modelName );
        ...
        private static string GetFirstLowerCasePropertyName( string propertyName ) {
            if( string.IsNullOrWhiteSpace( propertyName ) )
                return propertyName;
            return propertyName.Split( '.' ).Select(Helpers.String.FirstLowerCase ).ToList().Join( "", "." );
        }
