...
using TonyUtil.Ui.FlexLayout.Enums;

namespace TonyUtil.Ui.FlexLayout.Renders {
    /// <summary>
    /// 浮动布局项渲染器
    /// </summary>
    public class LayoutItemRender : AngularRenderBase {
        ...
        private void ConfigFlex( TagBuilder builder ) {
            ...
            Helpers.Enum.GetItems<BreakpointAlias>().ForEach( t => builder.AddAttribute( $"fxFlex.{t.Text}", _config.GetValue( $"{UiConst.Flex}-{t.Text}" ) ) );
        }
