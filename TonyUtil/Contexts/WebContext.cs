   ...
   public class WebContext:IContext
    {
        ...
        {
            if (HttpContextAccessor?.HttpContext == null) return default(T);
            return Helpers.Convert.To<T>(HttpContextAccessor.HttpContext.Items[key]);
        }
