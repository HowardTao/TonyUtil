   ...
   public static class Reflection
    {
        ...
        public static string GetDescription(MemberInfo member)
        {
            ...
            return member.GetCustomAttribute(typeof(DescriptionAttribute)) is DescriptionAttribute attribute
        ...
        {
            if (type == null) return string.Empty;
            return type.GetCustomAttribute(typeof(DisplayNameAttribute)) is DisplayNameAttribute attribute
        ...
        private static string GetDisplayName(MemberInfo member)
        {
            ...
            return member.GetCustomAttribute(typeof(DisplayAttribute)) is DisplayAttribute displayAttribute
        ...
        {
            var typeInterface = Common.GetType<TInterface>();
        ...
        {
            return Helpers.Convert.To<T>(Activator.CreateInstance(type, parameters));
        }
