...
namespace TonyUtil.Ui.Builders {
    ...
    public class TagBuilder : IHtmlContent {
        ...
        public TagBuilder Class( string @class ) {
            if( string.IsNullOrWhiteSpace( @class ) ) return this;
            if( _classList.Contains( @class ) ) return this;
        ...
        public TagBuilder AddAttribute( string name, string value, bool ignoreIfValueIsEmpty = true ) {
            if( ignoreIfValueIsEmpty && string.IsNullOrWhiteSpace( value ) )  return this;
