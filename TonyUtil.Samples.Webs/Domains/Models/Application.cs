...
namespace TonyUtil.Samples.Webs.Domains.Models
{
    /// <summary>
    /// 应用程序
    /// </summary>
    ...
    public class Application : AggregateRoot<Application>, IDelete, IAudited
    {
        ...
        {
            AddChange(t => t.Id, newEntity.Id);
            AddChange(t => t.Code, newEntity.Code);
            AddChange(t => t.Name, newEntity.Name);
            AddChange(t => t.Comment, newEntity.Comment);
            AddChange(t => t.Enabled, newEntity.Enabled);
            AddChange(t => t.RegisterEnabled, newEntity.RegisterEnabled);
            AddChange(t => t.CreationTime, newEntity.CreationTime);
            AddChange(t => t.CreatorId, newEntity.CreatorId);
            AddChange(t => t.LastModificationTime, newEntity.LastModificationTime);
            AddChange(t => t.LastModifierId, newEntity.LastModifierId);
        }
    }
}
