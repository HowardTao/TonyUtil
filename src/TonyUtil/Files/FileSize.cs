...
namespace TonyUtil.Files {
    ...
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
