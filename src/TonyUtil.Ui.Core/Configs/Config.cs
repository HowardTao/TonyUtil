   ...
   public class Config:IConfig
    {
        ...
        {
            return Contains(name) ? Helpers.Convert.To<T>(AllAttributes[name].Value) : default(T);
        }
        ...
        {
            return Helpers.String.FirstLowerCase(GetValue(name));
        }
        ...
        {
            if (replaceExisting == false && Contains(name)) return;
        ...
        public void AddClass(string @class)
        {
            ...
            if (_classList.Contains(@class)) return;
        ...
        {
            return IsValidate ? GetValidateMessage() : string.Empty;
        }
